...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        function BuildDayScollEventContainer(ht, dayarrs, events) {
			...
			console.log(ht);
			console.log(events);
			console.log(typeof(dayarrs))
			//dayarrs =  [{ name="CalendarTitle",  value="1234"}, { name="CalendarStartTime",  value="2016-4-11 11:30"}, { name="CalendarEndTime",  value="2016-4-11 12:30"}, { name="IsAllDayEvent",  value="0"}, { name="timezone",  value=8}];
